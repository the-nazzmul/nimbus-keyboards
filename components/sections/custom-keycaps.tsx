...
const CustomKeycaps = () => {
  ...
  return (
    <section
      id="custom-keycaps"
      className="relative flex h-[90vh] flex-col overflow-hidden bg-linear-to-b from-[#0f172a] to-[#062f4a] text-white"
    >
      {/* SVG Background */}
      <svg
      ...
      >
        ...
        <div className="min-h-0 max-md:max-h-[45vh] max-md:overflow-x-hidden max-md:overflow-y-auto">
